// Package followTaskLogs streams a task's output to the dashboard as
// it is written.
//
...
// seen enough.
//
// It is any task's log. Somebody who may only follow their own asks on
// followUserTaskLogs instead.
...
// FollowName is the subject a client opens a task's log on.
const FollowName = "runnerTaskLogs"
