...
func TestUseCase_Execute(t *testing.T) {
	...
	t.Run("failure because another user with given email exists", func(t *testing.T) {
		...
		languageResolver.AssertNotCalled(t, "Verify")
		userRepository.AssertNotCalled(t, "GetOneByIdentity", mock.Anything, r.Username)
		userRepository.AssertNotCalled(t, "GetOne")
		userRepository.AssertNotCalled(t, "Save")
	...
	t.Run("failure because another user with given username exists", func(t *testing.T) {
		...
		userRepository.On("GetOneByIdentity", mock.Anything, r.Email).Once().Return(u, nil)
		userRepository.On("GetOneByIdentity", mock.Anything, r.Username).Once().Return(anotherUserWithSameUsername, nil)
		defer userRepository.AssertExpectations(t)
	...
	t.Run("failure because the chosen language does not exist", func(t *testing.T) {
		...
		languageResolver.On("Verify", mock.Anything, r.LanguageCode).Once().Return(false)
		defer languageResolver.AssertExpectations(t)
	...
	t.Run("saving user info fails", func(t *testing.T) {
		...
		userRepository.On("GetOneByIdentity", mock.Anything, r.Username).Once().Return(u, nil)
		userRepository.On("GetOne", mock.Anything, r.UserUUID).Once().Return(u, nil)
		userRepository.On("Save", mock.Anything, &u).Once().Return("", expectedErr)
		defer userRepository.AssertExpectations(t)
