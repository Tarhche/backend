...
func NewResponse(n note.Note, language language.Language, author user.User, availableLanguages []language.Language, elementsResponse []element.Response) *Response {
