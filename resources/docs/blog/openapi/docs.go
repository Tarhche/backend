...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/getuserarticles.Response"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/updateuserarticle.Request"
                        }
                    }
                ],
                "responses": {
        ...
        "/dashboard/my/articles/{correlationUUID}/{language_code}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/getuserarticle.Response"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/getArticlesByHashtag.Response"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/oauth/authorization": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The authorization request, as the authorization endpoint signed it",
                        "name": "request",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/describeauthorization.Response"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The request being answered",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/approveauthorization.Request"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/approveauthorization.Response"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/oauth/authorize": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "The application asking",
                        "name": "client_id",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Where it is answered; one it registered",
                        "name": "redirect_uri",
                        "in": "query",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "The proof-key challenge",
                        "name": "code_challenge",
                        "in": "query",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Handed back untouched",
                        "name": "state",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "What the application wants to reach",
                        "name": "resource",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/registerclient.Request"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/registerclient.Response"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/oauth/token": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "The code the application was handed",
                        "name": "code",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "What the challenge was built from",
                        "name": "code_verifier",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "The address the code was given for",
                        "name": "redirect_uri",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "The refresh token being renewed",
                        "name": "refresh_token",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Its secret, when it has one",
                        "name": "client_secret",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/exchangecode.Response"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "approveauthorization.Request": {
            ...
            "properties": {
                "approved": {
                    "description": "Approved is the answer. A request that is not approved is refused, and\nthe application is told so at the address it registered.",
                    "type": "boolean"
                },
                "request": {
                    "description": "RequestToken is the authorization request as the authorization endpoint\nsigned it.",
                    "type": "string"
                }
            }
        },
        "approveauthorization.Response": {
            "type": "object",
            "properties": {
                "redirect_to": {
                    "type": "string"
        ...
        "describeauthorization.Response": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
        ...
        "getArticlesByHashtag.authorResponse": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
        ...
        "getArticlesByHashtag.paginationResponse": {
            "type": "object",
            "properties": {
                "current_page": {
                    "type": "integer"
        ...
        "getprofile.Response": {
            ...
            "properties": {
                ...
                "impersonated_by": {
                    "description": "ImpersonatedBy is who is seeing the dashboard as this user. It is absent\nfrom an ordinary session, and is what lets the dashboard say whose eyes\nthese are without being told by whoever is holding the token.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/getprofile.impersonatorResponse"
                        }
                    ]
                },
                "language_code": {
        ...
        "getprofile.impersonatorResponse": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
        ...
        "getuserarticle.Response": {
            "type": "object",
            "properties": {
                "author": {
                    "$ref": "#/definitions/getuserarticle.author"
                },
                "body": {
                    "type": "string"
                },
        ...
        "getuserarticles.Response": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/getuserarticles.articleResponse"
                    }
                },
                "pagination": {
                    "$ref": "#/definitions/getuserarticles.pagination"
                }
            }
        },
        "getuserarticles.articleResponse": {
            "type": "object",
            "properties": {
                "correlation_uuid": {
                    "type": "string"
                ...
                "corrolated_items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/getuserarticles.corrolatedArticleResponse"
                    }
                }
            }
        },
        "getuserarticles.author": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
        ...
        "getuserarticles.corrolatedArticleResponse": {
            "type": "object",
            "properties": {
                "author": {
                    "$ref": "#/definitions/getuserarticles.author"
                },
                "cover": {
                    "type": "string"
                },
                "language": {
                    "$ref": "#/definitions/getuserarticles.languageResponse"
                },
                "published_at": {
                    "type": "string"
                },
        ...
        "getuserarticles.languageResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "impersonateuser.Response": {
            ...
            "properties": {
                ...
                "user": {
                    "description": "User is who the tokens are for. The caller has just been handed a session\nthat is not theirs, so it is told whose it is, and does not have to ask.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/impersonateuser.userResponse"
                        }
                    ]
                }
            }
        },
        "impersonateuser.userResponse": {
            "type": "object",
            "properties": {
                "avatar": {
                    "type": "string"
        ...
        "registerclient.Response": {
            ...
            "properties": {
                ...
                "client_secret": {
                    "description": "ClientSecret is handed over once, here, and is never readable again. It\nis absent for a public client, which has none.",
                    "type": "string"
                },
                "client_secret_expires_at": {
                    "description": "ClientSecretExpiresAt is zero for a secret that does not expire, and\n[RFC 7591] asks for it whenever a secret was issued, zero included.\n\n[RFC 7591]: https://www.rfc-editor.org/rfc/rfc7591",
                    "type": "integer"
                },
                "client_uri": {
                    "type": "string"
