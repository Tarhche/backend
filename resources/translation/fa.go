...
var farsi = map[string]string{
	...
	"unknown_login_provider":            "ورود از این راه در اینجا پشتیبانی نمی‌شود",
	"invalid_login_provider_code":       "ورود کامل نشد، لطفاً دوباره تلاش کنید",
	"provider_email_not_verified":       "حسابی که با آن وارد شدید ایمیل تأییدشده ندارد",
