				...
				<div class="w-100 mt-3 mt-0 p-4">
					...
					<form action="#" class="signin-form d-flex flex-column" @submit.prevent="resetPassword()">
						<div class="form-group my-2">
							<input :class="{ 'is-invalid': errors.password }" type="text" placeholder="کلمه عبور جدید" class="input form-control py-2 " v-model="params.password" required>
							<div v-if="errors.password" class="invalid-feedback">
								{{ errors.password }}
							</div>
						</div>
						<div class="form-group my-2">
							<input :class="{ 'is-invalid': errors.repassword }" type="text" placeholder="تکرار کلمه عبور جدید" class="input form-control py-2 " v-model="params.repassword" required>
