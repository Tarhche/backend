          ...
          <div class="col-12 mb-4 mb-lg-0">
            ...
            <form class="card" action="#" @submit.prevent="createArticle">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  <input :class="{ 'is-invalid': errors.tags }" class="form-control" type="text"
                         placeholder="تگ ها (برای ثبت  بعد نوشتن هر تگ ctrl + Enter را فشار دهید)  " v-model.trim="params.tags"
                         aria-label="tags" @keydown.ctrl.enter="storeTags">
