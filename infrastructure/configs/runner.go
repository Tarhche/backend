...
type RunnerWorker struct {
	...
	PublicPortRange string `usage:"Range of ports this node accepts whole connections to its containers on, as \"first-last\". Empty serves http alone." env:"RUNNER_WORKER_PUBLIC_PORT_RANGE" long:"public-port-range"`
