...
func managerConsoleCommand(
	...
	ingressURL, err := url.Parse(managerConfigs.IngressURL)
	if err != nil {
		return nil, err
	}
	...
	mux.Handle("GET /api/tasks/{uuid}/attach", managerTaskAPI.NewAttachHandler(managerGetTaskUseCase, ingressURL, logger))
