...
func TestShowHandler(t *testing.T) {
	...
	t.Run("show home data", func(t *testing.T) {
		...
		articlesRepository.On("CountPublishedByHashtags", mock.Anything, []string{hashtag}, "EN").Once().Return(uint(len(articles)), nil)
		defer articlesRepository.AssertExpectations(t)

		articlesRepository.On("GetPublishedByHashtags", mock.Anything, []string{hashtag}, "EN", uint(0), uint(10)).Once().Return(articles, nil)
	...
	t.Run("no data", func(t *testing.T) {
		...
		articlesRepository.On("CountPublishedByHashtags", mock.Anything, []string{hashtag}, "EN").Once().Return(uint(0), nil)
		defer articlesRepository.AssertExpectations(t)

		articlesRepository.On("GetPublishedByHashtags", mock.Anything, []string{hashtag}, "EN", uint(0), uint(10)).Once().Return(nil, nil)
		elementsRepository.On("Count", mock.Anything).Once().Return(uint(0), nil)
		defer articlesRepository.AssertExpectations(t)
	...
	t.Run("error", func(t *testing.T) {
		...
		articlesRepository.On("CountPublishedByHashtags", mock.Anything, []string{hashtag}, "EN").Once().Return(uint(5), nil)
		defer articlesRepository.AssertExpectations(t)
