...
import (
	...
	runTask "github.com/khanzadimahdi/testproject/application/dashboard/runner/task/runTask"
...
// @Accept		json
// @Produce		json
// @Param		body	body		runTask.Request	true	"Task specification"
// @Success		201		{object}	runTask.Response
// @Failure		400		{object}	map[string]interface{}
// @Failure		500		{object}	map[string]interface{}
// @Router			/dashboard/runner/tasks [post]
