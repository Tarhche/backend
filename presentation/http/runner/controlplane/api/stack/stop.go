...
import (
	...
	stopstack "github.com/khanzadimahdi/testproject/application/runner/controlplane/stack/stopStack"
...
func (h *stopHandler) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	response, err := h.useCase.Execute(r.Context(), &stopstack.Request{UUID: r.PathValue("uuid")})
