...
import (
	...
	killtask "github.com/khanzadimahdi/testproject/application/runner/orchestrator/task/killTask"
...
// @Summary		Kill orchestrator task
...
func (h *killHandler) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	request := killtask.Request{UUID: r.PathValue("uuid")}
